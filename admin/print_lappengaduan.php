...
<body   onLoad="javascript:window.print()" style="margin:10px auto; width:950px;">
				...
				<p style="text-align:center; margin-top:10px; padding-top:10px; font-size:18px;">Laporan Data Pengaduan</p>
...
<h4 style="text-align:center; padding-bottom:0px; font-weight:normal;"> Bulan:<?PHP echo $bulan1;?><?php echo - $tahun;?></h4>
				      		...
				      		<table width="100%" border="0" cellspacing="0" cellpadding="3" style="border:1px solid #000; font-size:14px;">
							<tr style="background:#7cc623; color:#fff;">
								...
								<th style="border-right:1px solid #000;">Tanggal</th>
								...
								<th style="border-right:1px solid #000;">Pengaduan</th>  
								<th style="border-right:1px solid #000;">Keterangan</th> 		
								<th style="border-right:1px solid #000;">Tindakan</th> 		
								<th style="border-right:1px solid #000;">Foto</th> 		
								<th>Status</th>	
							</tr>
							...
							<td  style="border-right:1px solid #000; border-top:1px solid #000;padding:3px;" align="center"><?php echo $row1['kode1'];?></td>	
							<td  style="border-right:1px solid #000; border-top:1px solid #000;padding:3px;" align="center"><?php echo date('d-m-Y',strtotime($row1['tgl_pengaduan']));?></td>	
							...
							<td  style="border-right:1px solid #000; border-top:1px solid #000;padding:3px;"><?php echo $row1['jdl_pengaduan'];?></td>	
							<td  style="border-right:1px solid #000; border-top:1px solid #000;padding:3px;"><?php echo $row1['ket1'];?></td>	
							<td  style="border-right:1px solid #000; border-top:1px solid #000;padding:3px;"><?php echo $row1['ket2'];?></td>	
							<td  style="border-right:1px solid #000; border-top:1px solid #000;padding:3px;"><img src="foto/<?php echo $row1['foto']?>" width="150"></td>	
							<td  style=" border-top:1px solid #000;padding:3px;"><?php echo $row1['status'];?></td>	
							</tr>
                            <?php $i++; } ?>							
