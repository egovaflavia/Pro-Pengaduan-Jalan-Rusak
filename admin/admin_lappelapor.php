...
<div class="box">
<div class="box-head" >
						<h2 class="left">Laporan Data Pelapor</h2>						
					</div>
			  <form action="?aksi=cari" method="post">
				...
				<a href="print_lappelapor.php?bulan=<?php echo $_POST['bulan']; ?>&tahun=<?php echo $_POST['tahun'];?>&pimpinan=<?php echo $_POST['pimpinan'];?>" target="new"><input type="button" class="button" value="Cetak"></a>
                </form>
...
while($row = mysql_fetch_array($sql)) {		
	...
	?>							
							<tr<?php echo $klas;?>>
								<td><?php echo $i;?>.</td>
								<td><h3><a href="?"><?php echo $row['kd_pelapor']; ?></a></h3></td>
								<td><h3><a href="?"><?php echo $row['nm_pelapor']; ?></a></h3></td>
								<td><?php echo $row['alamat']; ?></td>
								<td><?php echo $row['tlp_pelapor']; ?></td>
