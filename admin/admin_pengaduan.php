						...
						<td >
							<div class="loginform_row" style="width:580px">
								...
								<select class="loginform_input" name="status" required >
												<option value="Dipilih" <?php if($data['status']=='Dipilih'){echo "selected"; } ?> >Dipilih</option>
												<option value="Diprioritaskan" <?php if($data['status']=='Diprioritaskan'){echo "selected"; } ?> >Diprioritaskan</option>
...
<!-- Box -->
				...
				<div class="scroll">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Pengaduan Jalan Rusak</h2>						
					</div>
						<div class="table">
...
while($row = mysql_fetch_array($sql)) {		
	...
	?>							
							<tr<?php echo $klas;?>>
								...
								<td><a href="?aksi=add&id=<?php echo $row['kd_pengaduan']; ?>">Pilih</a></td>
								</td>
